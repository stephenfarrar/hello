...
google.maps.event.addDomListener(window, 'load', function initialize() {
  ...
  buttonMarker();
  /*
  google.maps.event.addListener(document.getElementById("marker"), 'click', function(){
    buttonMarker();
  });
  google.maps.event.addListener(document.getElementById("geoCode"), 'click', function(){
    map = new google.maps.Map(document.getElementById('map-canvas'), {
      zoom: 12,
      center: new google.maps.LatLng(-33.8683, 151.2086),
      mapTypeId: google.maps.MapTypeId.ROADMAP
    ...
    document.getElementById("logGeo").style.visibility = "visible";
    document.getElementById("logMarker").style.visibility = "hidden";
  });
*/
